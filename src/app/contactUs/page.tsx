    ...
    <section className="mb-32">
        ...
        <div className="flex justify-center">
            <div className="text-center md:max-w-xl lg:max-w-3xl">
                <h2 className="mb-12 px-6 text-3xl font-bold font-serif hover:text-red-700 cursor-pointer">
                    Contact us
                </h2>
            </div>
        </div>
        ...
        <div className="flex flex-wrap">
            ...
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <button type="button"
                        className="mb-6 inline-block rounded bg-red-700 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md">
                        Send
                </button>
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                    ...
                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-6 grow">
                                <p className="mb-2 font-bold text-2x cursor-pointer">
                                    Phone
                                </p>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-6 grow">
                                <p className="mb-2 font-bold cursor-pointer">
                                    Sales questions
                                </p>
                                <p className="text-neutral-500 cursor-pointer">
                                    rehmanismail64@gmail.com
                                </p>
                                <p className="text-neutral-500 cursor-pointer">
                                    03161424118
                                </p>
