...
const ProductPage = () => {
    ...
    const [images, setImages] = useState({
        img1 : "https://d1iv6qgcmtzm6l.cloudfront.net/product_galleries/lg_5e60IE5Vs262fbhkyn9r0lwf2ycVa0f4uIv8phmC.png",
        img2 : "https://d1iv6qgcmtzm6l.cloudfront.net/product_galleries/lg_tE0FAOlqMPGI2nggAUtrXOcYNMxhcLkCj07heTgA.png",
    })
    ...
    return (
        <div className="flex max-h-screen flex-col items-center py-10">
            ...
            <div className='flex flex-col gap-4 lg:w-2/4'>
                <div>
                    <span className=' text-violet-600 font-semibold'>SHAARMS</span>
                    <h1 className='text-3xl font-bold'>Luxury WristWatch Men</h1>
                </div>
                ...
                <div className="flex items-center">
                    <p className="text-2xl font-semibold text-black cursor-auto my-3">Rs 3,750</p>
                    <del>
