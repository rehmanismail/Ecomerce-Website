...
const ProductPage = () => {
    ...
    const [images, setImages] = useState({
        img1 : "https://d1iv6qgcmtzm6l.cloudfront.net/product_galleries/lg_gK07qo7HQEVrtJT9WSze5RNxK1TSI5o1i8dDSWlN.jpg",
        img2 : "https://d1iv6qgcmtzm6l.cloudfront.net/product_galleries/lg_5VkHyyJxHLcIyadPDnvDnFRmK2H6IGbwtntHaQ97.jpg",
    })
    ...
    return (
        <div className="flex max-h-screen flex-col items-center py-10">
            ...
            <div className='flex flex-col gap-4 lg:w-2/4'>
                <div>
                    <span className=' text-violet-600 font-semibold'>Robits</span>
                    <h1 className='text-3xl font-bold'>Foldable Desk Mobile Phone Holder</h1>
                </div>
                ...
                <div className="flex items-center">
                    <p className="text-2xl font-semibold text-black cursor-auto my-3">Rs 25,000</p>
                    <del>
