...
const ProductPage = () => {
    ...
    const [images, setImages] = useState({
        img1 : "https://d1iv6qgcmtzm6l.cloudfront.net/products/lg_qdoCBBDwZqeJwSbYjvJWWFtfGLEJuLMNjQ5vcTxK.jpg",
        img2 : "https://d1iv6qgcmtzm6l.cloudfront.net/product_galleries/lg_zN3ebAtFyiQtZiHnM8KZypz22GFti4jOecSj915Y.jpg",
    })
    ...
    return (
        <div className="flex max-h-screen flex-col items-center py-10">
            ...
            <div className='flex flex-col gap-4 lg:w-2/4'>
                <div>
                    <span className=' text-violet-600 font-semibold'>PUMA</span>
                    <h1 className='text-3xl font-bold'>3 in 1 Zipper Set by MAT TIME</h1>
                </div>
                ...
                <div className="flex items-center">
                    <p className="text-2xl font-semibold text-black cursor-auto my-3">Rs 2,999</p>
                    <del>
